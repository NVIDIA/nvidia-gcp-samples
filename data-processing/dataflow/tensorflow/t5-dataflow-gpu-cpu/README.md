...
<br><br>
These examples are derived from [here](https://cloud.google.com/blog/products/data-analytics/ml-inference-in-dataflow-pipelines) and [here](../../tensorrt/bert-qa-trt-dataflow).
